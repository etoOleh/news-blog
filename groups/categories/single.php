    ...
    <div class="content clearfix">
        ...
        <div class="main-content-wrapper">
            <div class="main-content single ">
                ...
                //блок кода который выводит пост

                $sql = "select * from tbl_post where id=$id";
                $post = $db->select($sql);
                $post->execute();

                //блок кода который выводит гурппу
                ...
                //блок кода который выводит имя группы
                ...
                // блок кода котоырй выводит имя категорий
            ...
            <div class="section topics">
                ...
                <ul>
                    <?php
                        ...
                        // вывод всех категорий в слайлер
